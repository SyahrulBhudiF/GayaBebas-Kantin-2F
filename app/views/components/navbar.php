<nav class="flex w-full bg-Neutral/10">
    <div
        class="flex gap-2 items-center border-r border-b border-neutral-20 w-[15%] laptop1:w-[18%] laptop2:w-[20%] laptop3:w-[20%] p-6">
    ...
    <div class="flex justify-between items-center p-6 w-full">
        ...
        <div class="flex justify-center items-center gap-2 rounded-lg border border-neutral-30 px-4 py-4">
            ...
            <div>
                <p class="text-Neutral/100 font-semibold text-sm">Budi Setyawan</p>
                <p class="text-Neutral/60 text-xs">Admin</p>
            </div>
        </div>
    </div>
</nav>
