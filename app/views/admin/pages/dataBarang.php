...
<section class="flex flex-col fadeIn p-4 gap-2 w-full h-screen">
    <div class="flex flex-col bg-Neutral/10 rounded-[1.25rem] p-6 gap-6 h-[87%] laptop2:h-[85%]">
        <div class="flex justify-between">
            <label for="cari-barang" aria-label="search barang" title="search barang" class="flex justify-between px-7 py-3 border border-Neutral/30 rounded-full">
            ...
            <div class="flex gap-3">
                <a href="<?= BASEURL; ?>/requeststok">
                    <span id="request" class="flex gap-3 text-Primary-blue rounded-full cursor-pointer bg-Neutral/20 px-4 py-3 active:opacity-80" aria-label="req barang" title="request barang">
                        <p>
                            Request Stok
                        </p>
                ...
                <div class="flex flex-col border border-Neutral/30 rounded-3xl p-[0.2rem] div-barang">
                    <div class="flex flex-col items-center bg-Neutral/20 p-4 rounded-[1.25rem]">
                        <span class="bg-Neutral/10 px-5 py-2 rounded-full w-fit self-start"><?= $barang['stok']; ?>
                            Tersedia</span>
                        <img src="../public/Assets/img/barang/<?= $barang['foto']; ?>" alt="jajan" class="w-[50%]">
                    </div>
                    ...
                    <div class="flex gap-2 p-4 -mt-2 w-full">
                        <img src="../public/Assets/svg/trash.svg" alt="delete" class="deleteItem py-2 px-3 border rounded-full border-Neutral/40 cursor-pointer active:opacity-80" onclick="openModal('deleteBarang<?= $barang['id_barang']; ?>')" aria-label="delete" title="delete">
                        <button class="EditItem w-full bg-Neutral/20 rounded-full text-center p-3 text-Primary-blue active:opacity-80" onclick="openModal('editModalBarang<?= $barang['id_barang']; ?>')" aria-label="edit" title="edit">Edit</button>
                    </div>
                </div>
            <?php endforeach; ?>
