<section class="flex flex-col fadeIn p-4 gap-2 w-full h-screen">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tableContent flex justify-start gap-2">
                            <img onclick="openModal('editReqBarang<?= $request['id_request']; ?>')"
                                src="../public/Assets/svg/edit.svg" alt="edit"
                                class="p-3 rounded-full border border-Neutral/40 edit <?= $request['status'] === 'Sedang Diproses' ? '' : 'notActiveReject'; ?>">
                            <img onclick="openModal('deleteReq<?= $request['id_request']; ?>')"
                                src="../public/Assets/svg/trash.svg" alt="delete"
                                class="p-3 rounded-full border border-Neutral/40 delete <?= $request['status'] === 'Sedang Diproses' ? '' : 'notActiveReject'; ?>">
                        </td>
                    </tr>
                    <?php $no++;
                    endforeach; ?>
    ...
    <div id="editReqBarang<?= $value['id_request']; ?>"
        ...
        <div
            ...
            <div class="flex justify-between items-center">
                ...
                <button id="closeModal" class="cursor-pointer"
                    onclick="closeModal('editReqBarang<?= $value['id_request']; ?>')">
                    <img src="../public/Assets/svg/close.svg" alt="close">
                </button>
            </div>
            <form id="formEdit" class="flex flex-col gap-8 justify-center items-stretch"
                action="<?= BASEURL; ?>/operatorrequestbarang/ubahDataRequestById/<?= $value['id_request']; ?>"
                ...
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div
                            ...
                            <label for="inputImgEdit<?= $value['id_request']; ?>"
                                id="drop-area-edit<?= $value['id_request']; ?>"
                                class="flex flex-col justify-center items-center m-2 px-[20%] py-[2%] h-[28vh] laptop1:h-[32vh] laptop3:h-[30vh] laptop2:h-[36vh]">
                                <div class="flex flex-col items-start w-fit">
                                    <div class="flex justify-end w-full -mb-2 cursor-pointer"
                                        onclick="cancelUpEdit<?= $value['id_request']; ?>()">
                            ...
                            <input type="file" name="inputImgEdit" id="inputImgEdit<?= $value['id_request']; ?>"
    ...
    <!-- end modal edit -->
    <!-- start modal delete -->
    <div id="deleteReq<?= $value['id_request']; ?>"
        class="fixed inset-0 items-center justify-center z-50 bg-black bg-opacity-60 hidden">
        <div
            ...
            <div class="flex justify-between">
                ...
                <button class="px-[3.25rem] py-3 text-Neutral/100 bg-[#EEE] rounded-full"
                    onclick="closeModal('deleteReq<?= $value['id_request']; ?>')">Batal</button>
            </div>
        </div>
    </div>
    <?php endforeach; ?>
