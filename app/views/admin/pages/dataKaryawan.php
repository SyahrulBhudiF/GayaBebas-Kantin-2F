                    ...
                    foreach ($data['karyawan'] as $karyawan) : ?>
                        <tr>
                            ...
                            <td class="tableContent flex justify-start gap-2">
                                <img onclick="openModal('modalEdit<?= $karyawan['id_user']; ?>')" src="../public/Assets/svg/edit.svg" alt="edit" class="iconKaryawan edit">
                                <img onclick="openModal('modalDelete<?= $karyawan['id_user']; ?>')" src="../public/Assets/svg/trash.svg" alt="delete" class="iconKaryawan delete">
                            </td>
                        </tr>
                    <?php $no++;
                    endforeach; ?>
