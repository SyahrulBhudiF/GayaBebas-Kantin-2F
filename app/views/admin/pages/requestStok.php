        ...
        <section class="grid grid-cols-4 gap-4 p-2 overflow-auto" id="section-barang">
            ...
            <div class="flex flex-col border border-Neutral/30 rounded-3xl p-[0.2rem] div-barang">
                ...
                <div class="flex gap-2 p-4 -mt-2 w-full">
                    ...
                    <button class="w-full bg-Neutral/30 rounded-full text-center p-3 text-red-600 active:opacity-80"
                        onclick="openModal('modalReject<?= $value['id_request']; ?>')" aria-label="reject"
                        title="reject">Tolak</button>
                    <button class="w-full bg-Primary-blue rounded-full text-center p-3 text-white active:opacity-80"
                        onclick="openModal('modalAcc<?= $value['id_request']; ?>')" aria-label="acc"
