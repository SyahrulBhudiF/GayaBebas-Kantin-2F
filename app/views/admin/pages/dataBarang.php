        ...
        <section class="grid grid-cols-4 gap-4 p-2 overflow-auto" id="section-barang">
            ...
            <div class="flex flex-col border border-Neutral/30 rounded-3xl p-[0.2rem] div-barang">
                ...
                <div class="flex flex-col gap-3 p-4">
                    ...
                    <p class="text-Primary-blue text-xl font-semibold">Rp <?= $barang['hrg_jual']; ?><span
                    ...
                    <div class="grid grid-cols-2 gap-8">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div
                                ...
                                <input type="file" name="inputImgEdit" id="inputImgEdit" class="inputImg"
                                    value="<?= $barang['foto']; ?>" hidden>
                            </div>
                        </div>
                        <div class="flex flex-col gap-8">
                            <div class="flex flex-col gap-3">
            ...
            <div
                ...
                <div class="flex justify-between">
                    ...
                    <button class="px-[3.25rem] py-3 text-Neutral/100 bg-[#EEE] rounded-full"
                        onclick="closeDeleteBarang<?= $barang['id_barang']; ?>()">Batal</button>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
