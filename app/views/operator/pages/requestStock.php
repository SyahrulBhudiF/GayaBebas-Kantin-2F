...
<section class="flex flex-col fadeIn p-4 gap-2 w-full h-screen">
            ...
            <div class="flex flex-col border border-Neutral/30 rounded-3xl p-[0.2rem] div-barang">
                ...
                <div class="flex gap-2 p-4 -mt-2 w-full">
                    <button
                        ...
                        onclick="openModal('addReqStock<?= $barang['id_barang']; ?>')" aria-label="edit"
    ...
    <!-- add Modal -->
    <?php foreach ($data['barang'] as $barang) : ?>
    <div id="addReqStock<?= $barang['id_barang']; ?>"
        ...
        <div
            ...
            <div class="flex justify-between">
                ...
                <button id="closeModal" class="cursor-pointer"
                    onclick="closeModal('addReqStock<?= $barang['id_barang']; ?>')">
            ...
            <form class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <input type="number" name="stok" id="stok" class="inputKaryawan" value="<?= $barang['stok']; ?>">
                </div>
                <button type="submit"
                    class="self-end w-fit px-7 py-3 text-white bg-Primary-blue rounded-full">Request</button>
            </form>
        </div>
    </div>
    <?php endforeach; ?>
